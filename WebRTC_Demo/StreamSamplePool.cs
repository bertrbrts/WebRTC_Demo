...
{
    /// <summary>
    /// Pool of <see cref="MediaStreamSample"/> for video frames,
    /// which handles the <see cref="MediaStreamSample.Processed">
    /// event to recycle the underlying <see cref="Buffer"/>
    /// automatically once used.
    /// </summary>
    /// <remarks>
    /// This should be reimplemented in unmanaged code to benefit from low-level buffer
    /// access and avoid reallocating a new <see cref="MediaStreamSample"/>
    ...
    public class StreamSamplePool
    {
        ...
        /// from the front once the <see cref="MediaStreamSample.Processed"/>
        ...
        /// <remarks>
        /// The returned sample's buffer has a <see cref="Buffer.Length"/> property
        ...
        /// <summary>
        /// Callback fired by MediaFoundation when a <see cref="MediaStreamSample"/>
